import {
  ...
  getCheckList,
  checkAdd,
} from '@/services/productionFacility';
...
export default {
  ...
  effects: {
    ...
    *checkAdd({ payload, callback }, { call }) {
      const response = yield call(checkAdd, payload);
      const { code, msg } = response || {};
      callback && callback(code === 200, msg);
    },
    *scrap({ payload, callback }, { call }) {
