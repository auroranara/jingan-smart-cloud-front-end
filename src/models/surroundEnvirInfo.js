...
export default {
  ...
  effects: {
    ...
    *fetchEnvirInfoAdd({ payload, success, error }, { call, put }) {
    ...
    // 查看
    *fetchEnvirDetail({ payload, callback }, { call, put }) {
      const response = yield call(queryEnvirInfoDetail, payload);
      if (response.code === 200) {
        yield put({
          type: 'saveEnvirDetail',
