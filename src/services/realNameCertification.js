...
// 刷新通道设备
export async function refreshChannelDevice (params) {
  return request(`/acloud_new/v2/ci/hgEquipmentInfo/restartEquipmentInfo?${stringify(params)}`)
}

// 重启通道设备
export async function restartChannelDevice (params) {
  return request(`/acloud_new/v2/ci/hgEquipmentInfo/refreshEquipmentInfo?${stringify(params)}`)
}

// 禁用通道设备
export async function disabledChannelDevice (params) {
  return request(`/acloud_new/v2/ci/hgEquipmentInfo/forbiddenEquipmentInfo?${stringify(params)}`)
}

// 启用通道设备
export async function enableChannelDevice (params) {
  return request(`/acloud_new/v2/ci/hgEquipmentInfo/startEquipmentInfo?${stringify(params)}`)
}
