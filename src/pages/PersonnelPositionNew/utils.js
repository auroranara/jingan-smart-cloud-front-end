...
export function getSrc(type, ip, buildId, secret, appId) {
  return `http://${ip}/js/tunnel.html?to=${type}&buildId=${buildId || BUILD_ID}&appid=${appId || APP_ID}&secret=${secret}&wh=false${getMoreParams(type)}`;
