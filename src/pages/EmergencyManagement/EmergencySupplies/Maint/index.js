...
const REMOVE = 'emergencyManagement/deleteMaterialmentMaint';

export const DETAIL_CODE = 'emergencyManagement.emergencySupplies.maintDetail';
export const ADD_CODE = 'emergencyManagement.emergencySupplies.maintAdd';
export const EDIT_CODE = 'emergencyManagement.emergencySupplies.maintEdit';
export const DELETE_CODE = 'emergencyManagement.emergencySupplies.maintDelete';
export const ORGIN_PATH = '/emergency-management/emergency-supplies/list';
export const PATH = '/emergency-management/emergency-supplies/maint';
...
export default class MaterialMaintList extends PureComponent {
  prevValues = null;
  ...
  render() {
    const {
      emergencyManagement: {
        emergencyEquip = [],
        maint: { materialName = '', materialType = '', materialCode = '' } = {},
      },
    } = this.props;
    const title = '维保记录';
