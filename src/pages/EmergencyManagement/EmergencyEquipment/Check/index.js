...
const REMOVE = 'emergencyManagement/deleteEquipmentCheck';

export const DETAIL_CODE = 'emergencyManagement.emergencyEquipment.checkDetail';
export const ADD_CODE = 'emergencyManagement.emergencyEquipment.checkAdd';
export const EDIT_CODE = 'emergencyManagement.emergencyEquipment.checkEdit';
export const DELETE_CODE = 'emergencyManagement.emergencyEquipment.checkDelete';
export const ORGIN_PATH = '/emergency-management/emergency-equipment/list';
export const PATH = '/emergency-management/emergency-equipment/check';
...
export default class EquipCheckList extends PureComponent {
  prevValues = null;
  ...
  render() {
    const {
      emergencyManagement: {
        emergencyOutfit = [],
        check: { equipName = '', equipType = '', equipCode, equipModel } = {},
      },
    } = this.props;
    const title = '检查记录';
