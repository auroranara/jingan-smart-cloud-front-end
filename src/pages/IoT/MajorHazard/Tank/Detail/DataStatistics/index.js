...
import iconSafeDuration from '../../../imgs/icon-safe-duration.png';
          ...
          <Row gutter={24}>
            <Col xs={24} sm={12} xl={8}>
              <div className={classNames(styles.statisticalCard, styles.alarmRateCard)}>
                <div className={styles.statisticalCardIcon} style={{ backgroundImage: `url('${iconSafeDuration}')` }} />
                <div className={styles.statisticalCardContent}>
                  <div className={styles.statisticalCardContentLabel}>安全运行时长（h）</div>
                  <div className={styles.statisticalCardContentValue}>{safeDuration}</div>
                </div>
              </div>
            </Col>
            <Col xs={24} sm={12} xl={8}>
