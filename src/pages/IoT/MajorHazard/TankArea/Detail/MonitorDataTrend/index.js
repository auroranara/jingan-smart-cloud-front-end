...
export default class MonitorDataTrend extends Component {
  ...
  componentDidUpdate({ majorHazardMonitor: { tankAreaDetail: { pointList: prevPointList }={} } }) {
    const { majorHazardMonitor: { tankAreaDetail: { pointList }={} } } = this.props;
  ...
  render() {
    ...
    const paramList2 = Array.isArray(tankAreaMonitorDataTrend) ? tankAreaMonitorDataTrend : [];
