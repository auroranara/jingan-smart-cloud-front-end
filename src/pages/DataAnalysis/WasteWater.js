...
import { WASTE_WATER_TYPE, WASTE_WATER_PARAMS as PARAMS, WASTE_WATER_COLUMNS as COLUMNS, PAGE_SIZE, getFields } from './constant';
import { addAlign,getThisMonth, handleFormVals, handleTableData, isDateDisabled } from './utils';

// 废水
const TYPE = WASTE_WATER_TYPE;
...
export default class ToxicGas extends PureComponent {
  ...
  render() {
    ...
    const fields = getFields(WASTE_WATER_TYPE, methods, PARAMS);
