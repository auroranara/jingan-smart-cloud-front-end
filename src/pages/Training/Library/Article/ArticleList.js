...
const data = [
  {
    title:
      '文章一按时大撒大撒大撒按时大撒大撒大撒按时大撒大撒大撒按时大撒大撒大撒按时大撒大撒大撒按时大撒大撒大撒按时大撒大撒大撒',
  ...
  {
    title:
      '按时大撒大撒大撒asdsadsadsadassssssssssssssssssssssssssasdsadsadsadassssssssssssssssssssssssssasdsadsadsadassssssssssssssssssssssssssaa',
    content: 'asdsadsadsadassssssssssssssssssssssssss',
    author: '啊是大',
    id: '002',
    view: 1000,
          ...
          renderItem={item => (
            <ListItem>
              <Card className={styles.cardContainer}>
                <div className={styles.firstLine}>
                  ...
                  <div className={styles.rightIcon}>
                    <Icon
                      ...
                      type="edit"
                      onClick={() => {
                        router.push(`/training/library/article/edit/${item.id}`);
                      }}
                    />
                ...
                <Tag className={styles.tags} color={item.status ? 'blue' : 'grey'}>
                  {item.status ? '已发布' : '未发布'}
                </Tag>
