    ...
    <div className={isFromMobile?styles.mobileContainer:styles.container}>
      {!isFromMobile && (
        <div className={styles.header}>
          ...
          <div className={styles.backButtonWrapper}>
            <Button className={styles.backButton} type="primary" size="large" onClick={() => {router.push('/limin/user/login');}}>返回</Button>
          </div>
        </div>
      )}
      <div className={styles.content}>
        <div className={styles.contentInner}>
          ...
          <div className={styles.layer}><img src="http://data.jingan-china.cn/v2/login/limin/limin_download_layer.png" alt="" /></div>
          ...
          {isFromMobile && (
            <div className={styles.buttonWrapper}>
              ...
              <div className={styles.loginButton} onClick={() => {router.push('/limin/user/login');}}>登录</div>
            </div>
          )}
        </div>
      </div>
