  ...
  return (
    <div className={styles.danger}>
      <Row gutter={20} style={{ margin: 0, height: '100%' }}>
        ...
        <Col style={{ height: '100%' }} span={6}><OvCard title="总数" num={0} zeroLength={3} /></Col>
        <Col style={{ height: '100%' }} span={12}>
          <Row style={{ height: '100%', position: 'relative' }}>
            <Col style={{ height: '100%' }} span={8}><OvCard title="已超期" num={0} numStyle={numStyle} style={style1} titleContainerStyle={style1} /></Col>
            <Col style={{ height: '100%' }} span={8}><OvCard title="待整改" num={0} numStyle={numStyle} style={style2} titleContainerStyle={style2} /></Col>
            <Col style={{ height: '100%' }} span={8}><OvCard title="待复查" num={0} numStyle={numStyle} style={style3} titleContainerStyle={style3} /></Col>
