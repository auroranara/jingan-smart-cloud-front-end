      ...
      <Section title="维保统计">
        ...
        <div className={styles.bottom}>
          <div className={styles.itemWrapper}>
            <div className={styles.item} onClick={()=>{handleShowOrder('workOrder', { drawerType: 7 });}}>
              <div className={styles.itemValue} style={{ color: '#ff4848' }}>1</div>
              <div className={styles.itemLabel}>已超期工单</div>
            </div>
          </div>
          <div className={styles.itemWrapper}>
            <div className={styles.item} onClick={()=>{handleShowOrder('workOrder', { drawerType: 2 });}}>
              <div className={styles.itemValue} style={{ color: '#04fdff' }}>7</div>
              <div className={styles.itemLabel}>未超期工单</div>
            </div>
          </div>
          <div className={styles.itemWrapper}>
            <div className={styles.item} onClick={()=>{handleShowOrder('workOrder', { drawerType: 1 });}}>
