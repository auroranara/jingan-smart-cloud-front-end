    ...
    return (
      ...
      >
        <div className={styles.top}>
          <div className={styles.line}>
            ...
            <div className={styles.value}>
              ...
              {videoList && videoList.length > 0 && (
                <span className={styles.video} onClick={this.showVideo} />
              )}
          ...
          <div className={styles.line}>
            <div className={styles.label}><span className={styles.number}>位号</span>：</div>
        ...
        <div className={styles.middle}>
          ...
          <div className={styles.infoWrapper}>
            <div className={styles.line}>
              ...
              <div className={styles.value}>{upateTime && moment(upateTime).format(DEFAULT_FORMAT)}</div>
            </div>
            <div className={styles.line}>
            ...
            <div className={styles.lineWrapper}>
              ...
              <div className={style.line}>
                ...
                <div className={styles.value} style={{ color: temperatureStatus > 0 ? '#ff4848' : '#0ff' }}>{temperatureStatus > 0 ? '报警' : '正常' }</div>
              </div>
            </div>
            <div className={styles.lineWrapper}>
              <div className={styles.line}>
              ...
              <div className={style.line}>
                <div className={styles.label}>状态：</div>
                <div className={styles.value} style={{ color: liquidLevelStatus > 0 ? '#ff4848' : '#0ff' }}>{liquidLevelStatus > 0 ? '报警' : '正常' }</div>
              </div>
            </div>
            <div className={styles.lineWrapper}>
              <div className={styles.line}>
              ...
              <div className={style.line}>
                <div className={styles.label}>状态：</div>
                <div className={styles.value} style={{ color: pressureStatus > 0 ? '#ff4848' : '#0ff' }}>{pressureStatus > 0 ? '报警' : '正常' }</div>
              </div>
            </div>
          </div>
        </div>
        <div className={styles.bottom}>
          <div className={styles.bottomTitle}>
            ...
            <div className={styles.bottomTitleLabel}>
              应急处置措施
            </div>
          </div>
