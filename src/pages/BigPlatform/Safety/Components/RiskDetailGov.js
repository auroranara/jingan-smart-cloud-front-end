      ...
      >
        <div
          ...
          style={{
            ...
            // borderImage: `url(${detailBorder}) 10`,
                      ...
                      style={{
                        ...
                        transition:
                          currentFirstIndex === index
                            ? 'top 0.55s, bottom 0.55s'
                            : 'top 0.5s, bottom 0.5s',
                      }}
                      key={ele[id]}
                    >
                          ...
                          <div style={{ display: 'flex', padding: '0 0 10px 6px' }}>
                            ...
                            <div style={{ flex: 1 }}>
                              ...
                              >
                                ...
                                <Ellipsis
                                  lines={1}
                                  style={{ flex: 1, color: '#fff', lineHeight: 1 }}
                                >
