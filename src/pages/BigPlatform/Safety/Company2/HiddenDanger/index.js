      ...
      <div className={styles.riskDetailItem} style={style}>
        ...
        <div className={styles.riskDetailItemContentWrapper}>
          ...
          <div className={styles.riskDetailItemInfoWrapper}>
            ...
            {isSourceShow && <div className={styles.riskDetailItemTextWrapper}><span style={{ flex: 'none', color: '#00A8FF' }}>来<span style={{ opacity: 0 }}>隐藏</span>源：</span><Ellipsis tooltip lines={1} style={{ flex: 1, color: '#fff', height: 24 }} ><span className={styles.riskDetailItemTextFirstChild}>{source_type_name}</span></Ellipsis></div>}
          </div>
        </div>
