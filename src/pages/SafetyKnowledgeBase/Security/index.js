...
import {
  ...
  NAMESPACE,
  SECURITY_LIST_API,
} from '@/pages/MajorHazardDistribution/config';
...
export default class Security extends Component {
  ...
  componentDidUpdate({
    unitId: prevUnitId,
    match: {
      params: { targetId: prevParentId, id: prevId },
    },
  }) {
    const {
      unitId,
    ...
    if (unitId) {
      if (unitId !== prevUnitId || targetId !== prevParentId || id !== prevId) {
